...
const BankStatementImport: React.FC<BankStatementImportProps> = ({
  ...
  const handleFileUpload = async (file: File) => {
    try {
      ...
      const response = await axios.post('/api/import/bank-statement', formData, {
        headers: {
  ...
  return (
    ...
    >
      <Alert
        message="Banka Ekstresi Formatı"
        description="Banka ekstresi dosyasını yükleyin. Dosya şu sütunları içermelidir: Tarih, Açıklama, Tutar, Kategori, Hesap, Tür (opsiyonel)"
        type="info"
        showIcon
