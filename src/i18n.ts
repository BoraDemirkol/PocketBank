...
const resources = {
  en: {
    translation: {
      ...
      "logout.confirmMessage": "Are you sure you want to logout? You will need to sign in again to access your account.",
  ...
  tr: {
    translation: {
      ...
      "logout": "Çıkış Yap",
      "logout.confirmTitle": "Çıkış Onayı",
      "logout.confirm": "Çıkış Yap",
      "logout.confirmMessage": "Çıkış yapmak istediğinizden emin misiniz? Hesabınıza erişmek için tekrar giriş yapmanız gerekecek.",
      ...
      "importTransactions": "İşlem İçe Aktarma",
